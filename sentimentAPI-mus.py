...
#error tak boleh install textblob
...
class TwitterClient(object):
    ...
    def __init__(self):
        ...
        access_token = 'xVPabuKZBk2Js6GNDdQOXmkUlKAiwl6idSmlSoGwWGrMnzpveF'
...
def main():
    ...
    nama = raw_input("Search for:");

    tweets = api.get_tweets(query=nama, count=200)
